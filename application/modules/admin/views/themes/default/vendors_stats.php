        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                   Στατιστικά Στοιχεία Προμηθευτή έτους <?php echo date('Y') ?>
                   <a href="<?= base_url('admin/vendors/') ?>" class="btn btn-info" style="float: right">Πίσω</a>
                </div>
                <!-- /.panel-heading -->
                    ...
                    <div class="dataTable_wrapper">
                            ...
                            <tbody>
                                 <tr class="odd gradeX">
                                     ...
                                     <td><a href="<?= base_url('admin/vendors/stats_all/'. $vendors->id) ?>" class="btn btn-info">More Stats</a></td>
                                 </tr>                                                                 
                            </tbody>
                        </table>
                    </div>
