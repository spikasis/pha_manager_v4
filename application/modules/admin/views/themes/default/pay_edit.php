                        ...
                        <div class="col-lg-6">
                            <form role="form" method="POST" action="<?= base_url('admin/pays/edit/' . $pay->id) ?>">
                                <div class="form-group">
                                    <label>ID</label>
                                    <input class="form-control" value="<?= $pay->id ?>" placeholder="Auto generated" disabled="1">
                                </div>
                                <div class="form-group">
                                    <label>Ημερομηνία</label>
                                    <input class="form-control" type="date" value="<?= $pay->date ?>" placeholder="Εισαγάγετε Ημερομηνία" id="date" name="date">
                                </div>
                                <div class="form-group">
                                    <label>Πελάτης</label>
                                    <select class="form-control" id="customer" name="customer">
                                        <?php if (count($customers)): ?>
                                            <?php foreach ($customers as $key => $customer): ?>
                                                <option value="<?= $customer['id'] ?>" <?= ($pay->customer == $customer['id']) ? 'selected="selected"' : '' ?>> <?= $customer['name'] ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>                                    
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="<?= $pay->pay ?>" placeholder="Εισαγάγετε Ποσό" id="pay" name="pay">
                                </div>                                
