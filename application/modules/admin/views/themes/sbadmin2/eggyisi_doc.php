<div id="page-wrapper" align="justify" lang="el" style="width: 210mm; height: 297mm">
    ...
    <p><br></p>
    <h2 align="center">ΒΕΒΑΙΩΣΗ ΠΩΛΗΣΗΣ - ΕΓΓΥΗΣΗ ΚΑΛΗΣ ΛΕΙΤΟΥΡΓΙΑΣ</h2>
    <p><br></p>
    <table width="100%" id="t01">
        ...
        <tr><td> ΤΥΠΟΣ ΑΚΟΥΣΤΙΚΟΥ:</td><td><strong><?php echo $ha_model->model?>- <?php echo $ha_type?></strong></td></tr>
