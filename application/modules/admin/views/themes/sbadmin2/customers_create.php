...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-user-plus text-primary"></i> Δημιουργία Νέου Πελάτη
        </h1>
    ...
    <form method="POST" action="<?= base_url('admin/customers/create') ?>" class="needs-validation" novalidate>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" 
                                   placeholder="Εισάγετε το πλήρες ονοματεπώνυμο" required>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="amka" name="amka" 
                                   placeholder="Αριθμός Μητρώου Κοινωνικής Ασφάλισης" maxlength="11">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="phone_mobile" name="phone_mobile" 
                                   placeholder="π.χ. 6971234567" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="address" name="address" 
                                   placeholder="Εισάγετε τη διεύθυνση (οδός, αριθμός, περιοχή)">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="customer_id" name="customer_id" 
                                   placeholder="Προαιρετικός εξωτερικός κωδικός">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="comments" name="comments" rows="3" 
                                      placeholder="Εισάγετε τυχόν σχόλια, παρατηρήσεις ή ειδικές οδηγίες για τον πελάτη..."></textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-body text-center">
                <button type="submit" class="btn btn-success btn-lg mr-3">
                    <i class="fas fa-save"></i> Δημιουργία Πελάτη
                </button>
                <button type="reset" class="btn btn-warning btn-lg mr-3">
                    <i class="fas fa-undo"></i> Επαναφορά Φόρμας
                </button>
...
$(document).ready(function() {
    ...
    // Set current date as default for first_visit if empty
    if ($('#first_visit').val() === '') {
        $('#first_visit').val(new Date().toISOString().split('T')[0]);
    }
});
</script>
