        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" method="POST" action="<?= base_url('admin/pays/create_specific/' . $customers->id ) ?>">
                            ...
                            <a href="<?= base_url('admin/stocks/pays/' . $stocks['id']) ?>" class="btn btn-warning">Πίσω στην καρτέλα δόσεων</a>
                        </div>
                    </div>
                    <!-- /.row (nested) -->
                </div>
