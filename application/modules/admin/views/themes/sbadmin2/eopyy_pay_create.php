        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" method="POST" action="<?= base_url('admin/eopyy_pays/create/') ?>">
                                ...
                                <div class="form-group">
                                    <label>Ποσό</label>
                                    <input class="form-control" placeholder="Εισαγάγετε Ποσό" id="price" name="price">
                                </div>                     
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Εισαγάγετε Σημείωση" id="comments" name="comments">
                                </div>
