<div id="page-wrapper" align="justify" lang="el" style="width: 210mm; height: 297mm">
    ...
    <table width="100%" id="t01">
        ...
        <tr><td> ΑΜΚΑ:</td><td><strong><?php if(isset($customer->amka)) echo $customer->amka ?></strong></td></tr>
        ...
        <tr><td> ΤΥΠΟΣ ΑΚΟΥΣΤΙΚΟΥ:</td><td><strong><?php echo $ha_series->series?>-<?php echo $ha_model->model?> - <?php echo $type->type ?></strong></td></tr>
        <tr><td> SERIAL NO:</td><td><strong><?php echo $stock->serial ?></strong></td></tr>
        <tr><td> BARCODE ΕΟΠΥΥ:</td><td><strong><?php echo $stock->ekapty_code ?></strong></td></tr>
        <tr><td> ΑΡ. ΕΚΤΕΛΕΣΗΣ ΕΟΠΥΥ:</td><td><strong><?php echo $stock->ektelesi_eopyy ?></strong></td></tr>
    </table>
    <p><br></p>
