    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Alerts -->
                <span class="badge badge-danger badge-counter"><?= isset($pending_notifications) ? $pending_notifications : '3+' ?></span>
            </a>
            <!-- Dropdown - Alerts -->
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    ...
                    <div>
                        <div class="small text-gray-500">7 Νοεμβρίου, 2025</div>
                        <span class="font-weight-bold">Νέα παραγγελία για επεξεργασία!</span>
                    </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="mr-3">
                    ...
                    <div>
                        <div class="small text-gray-500">7 Νοεμβρίου, 2025</div>
                        Έγινε κατάθεση €290.29 στο λογαριασμό σας!
                    </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="mr-3">
                    ...
                    <div>
                        <div class="small text-gray-500">7 Νοεμβρίου, 2025</div>
                        Προσοχή! Εκκρεμεί πληρωμή για παραγγελία #234
                    </div>
                </a>
                <a class="dropdown-item text-center small text-gray-500" href="#">Εμφάνιση όλων</a>
            </div>
        </li>
