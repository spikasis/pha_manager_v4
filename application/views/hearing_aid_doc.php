<div  lang="el" style="width: 21cm">
    <div class="row" >
        <div class="col-lg-4 " style="display: inline-block; margin:5px; width: 45%; float: left"><img src="<?= base_url() ?>images/logo_pha.png" style="height: 80px" alt=""/></div> 
        <div class="col-lg-4 " style="display: inline-block; margin:5px; width: 45%; float: right"><h2><?php echo $customer->name ?></h2></div>
        
  </div>
    <div class="col-lg-4 " style="display: inline-block; margin:5px; width: 50%"><h3>Serial No: <?php echo $stock->serial ?></h3></div>
    <div class="row" >
        <h3>            
