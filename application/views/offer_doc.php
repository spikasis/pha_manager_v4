        ...
        <table style="width: 900px;">
            <tbody>
                <tr>
                    ...
                    <td style="width: 400px;" style="align-content: center"></td>
                    <td><strong>Ημ/νια Προσφοράς: <?php echo $offer->offer_date?></strong></td>
                </tr>
                <tr>
                    <td><strong>Κέντρο Ακοής <?php echo $selling_point->city?>ς</strong></td><!-- comment -->
                </tr>
            </tbody>
        </table>
