...
class MY_Email extends CI_Email {
    ...
    var $imap_host      = "imap.gmail.com";       // IMAP Server.  Example: mail.earthlink.net
    var $imap_user      = "info@pikasishearing.gr";       // IMAP User.
    var $imap_pass      = "038213sp";       // IMAP Password.
    var $imap_port      = "456";       // IMAP Port. Example: 993 for secure connection.
    var $imap_mailbox   = "";       // IMAP Mailbox.  Example: INBOX
    var $imap_path      = "";       // IMAP Mailbox Path. Example: 'imap/ssl'
    var $imap_server_encoding   = "UTF-8";   // IMAP server encoding
